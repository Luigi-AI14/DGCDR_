...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description="Run LightGCN on a single domain dataset")
    ...
    # Run RecBole training for LightGCN
    run_recbole(model='LightGCN', dataset=args.dataset, config_dict=config_dict)
